 ...
 */
public abstract class BindingBottomSheetDialogFragment<T : ViewDataBinding>(
   ...
   */
  @BindingOnly protected val binding: T
   ...
   */
  @BindingOnly protected inline fun binding(block: T.() -> Unit): T {
